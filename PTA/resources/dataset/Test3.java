...
Test3Lib.local4.field4=Test3Lib.local4.field4;
for (int local18 = 0; local18<=3; local18 += 1) {
Test3Lib.local2=Test3Lib.local2.field1;
}
Test3Lib.local4.field3=Test3Lib.local4.field3;
Test3Lib.local1.field1.method2(Test3Lib.local4.field2,Test3Lib.local3.field1,3);
Test3Lib.local4.field1=Test3Lib.local4.field4.method6(3);
Test3Lib.local4.field5=Test3Lib.local4.field4.method5(Test3Lib.local4,Test3Lib.local4.field4,3);
if (inputValue==2) {
Test3Lib.local4.method6(3);
}
if (inputValue==4) {
if (inputValue>=1) {
for (int local19 = 0; local19<=2; local19 += 1) {
for (int local20 = 0; local20<=3; local20 += 1) {
Test3Lib.local4=Test3Lib.local4.field3;
}
}
}
}
for (int local21 = 0; local21<=1; local21 += 1) {
Test3Lib.local4.field3=Test3Lib.local4.field4;
}
