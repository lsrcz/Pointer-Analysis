...
public class InterProcedureAndersonNFS extends ForwardInterProceduralAnalysis<SootMethod, Unit, Map<Local, FlowSet<NewExpr>>> {
    private static final Local RETURN_LOCAL = new JimpleLocal("@return", IntType.v());

    public InterProcedureAndersonNFS() {
        verbose = true;
    }
